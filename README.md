...
- 对 RoboMaster 赛事与 Taurus 团队有较强热情，愿意长期投入训练和研发。
- 掌握 Ubuntu 系统的基本操作，能够使用终端、管理文件并配置开发环境。
- 掌握 C++ 或 Python，具备阅读、调试和理解源码的能力。
- 熟悉 ROS 2 的基本通信机制，理解节点、话题、服务、动作和参数等概念。
- 对机器人定位、建图、导航、规划和决策算法有持续学习兴趣。
- 对通信、信号处理或协议分析感兴趣者，可进一步参与无线电方向。
- 有机器人项目、机器人比赛、ACM 或数学建模经历者优先。
...
![导航组招新考核流程](assets/navigation-recruitment-schedule.jpg)

日期按招新通知原图记录，实验室地点及后续安排以群内最新通知为准。

### 一面 线上提交

- **9 月 13 日**：发布一面考核题。
- **9 月 25 日**：一面考核截止提交。
- **9 月 27 日 10:00**：在实验室进行线下面试。
  - 携带纸质版简历。
  - 现场讲解代码逻辑，并回答相关问题。
- **9 月 28 日**：公布第一轮面试通过名单。

### 二面 线下考核

- **10 月 17 日**：线下考核，现场编写代码并现场审核，具体地点届时通知。
- **10 月 18 日**：公布准预备队员名单。

考核流程还包含行测考题，具体形式和要求以后续通知为准。
